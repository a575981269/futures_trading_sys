...
| 特性 | CTP主席系统 | 7x24环境 |
|------|------------|---------|
| 端口 | 30001/30011 | 40001/40011 |
| 交易时间 | 正常交易时间 | 全天候（有限制） |
| 清算时间 | 16:00-19:00 不开放 | 12:00-16:00 不开放 |
| 适用场景 | 正常交易 | 非交易时间测试 |
| 新用户限制 | 无 | 需等第三个交易日 |
...
1. **是否选择了正确的环境**：
   - **CTP 主席系统**：在非交易时间不开放
     - 日盘：09:00-15:00
     - 夜盘：21:00-02:30（部分品种）
     - 清算时间：16:00-19:00（系统不开放）
   - **7x24 环境**：全天候开放（适合非交易时间测试）
     - 交易日：16:00 ～ 次日 09:00
     - 非交易日：16:00 ～ 次日 12:00
     - 新注册用户需要等到第三个交易日才能使用
2. 密码是否正确（在 `.env` 文件中设置）
3. 网络连接是否正常
4. SimNow 服务器是否正常（查看官网状态）
